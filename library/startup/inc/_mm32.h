...
#define  ADC_DR_CH0                     (0x00U << ADC_DR_CH_Pos)                ///< ADC Channal select  0
#define  ADC_DR_CH1                     (0x01U << ADC_DR_CH_Pos)                ///< ADC Channal select  1
#define  ADC_DR_CH2                     (0x02U << ADC_DR_CH_Pos)                ///< ADC Channal select  2
#define  ADC_DR_CH3                     (0x03U << ADC_DR_CH_Pos)                ///< ADC Channal select  3
#define  ADC_DR_CH4                     (0x04U << ADC_DR_CH_Pos)                ///< ADC Channal select  4
#define  ADC_DR_CH5                     (0x05U << ADC_DR_CH_Pos)                ///< ADC Channal select  5
#define  ADC_DR_CH6                     (0x06U << ADC_DR_CH_Pos)                ///< ADC Channal select  6
#define  ADC_DR_CH7                     (0x07U << ADC_DR_CH_Pos)                ///< ADC Channal select  7

#if defined(__MM3N1)
    #define  ADC_DR_Sensor              (0x08U << ADC_DR_CH_Pos)                ///< ADC Channal select  8
#endif

#if defined(__MM0N1) || defined(__MM0P1) || defined(__MM0Q1)
    #define  ADC_DR_CH8                 (0x08U << ADC_DR_CH_Pos)                ///< ADC Channal select  8
    #define  ADC_DR_CH9                 (0x09U << ADC_DR_CH_Pos)                ///< ADC Channal select  9
    #define  ADC_DR_TempSensor          (0x0EU << ADC_DR_CH_Pos)                ///< ADC Channal select  14
    #define  ADC_DR_VoltRef             (0x0FU << ADC_DR_CH_Pos)                ///< ADC Channal select  15
#endif

#if defined(__MM0P1) || defined(__MM0Q1)
    #define  ADC_DR_CH10                (0x0AU << ADC_DR_CH_Pos)                ///< ADC Channal select  10
    #define  ADC_DR_CH11                (0x0BU << ADC_DR_CH_Pos)                ///< ADC Channal select  11
    #define  ADC_DR_CH13                (0x0CU << ADC_DR_CH_Pos)                ///< ADC Channal select  13
#endif
...
#define COMP_CSR_OUT_STA_Pos            (30)
#define COMP_CSR_OUT_STA                (0x01U << COMP_CSR_OUT_STA_Pos)         ///< Comparator output status
